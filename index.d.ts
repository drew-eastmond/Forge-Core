declare module "@onyx-ignition/forge-core" {
	...
	export declare class MapCollection<T = unknown> implements ICollection<T, T> {
	...
	export declare class Topology<T = unknown> {
	...
	export declare class TreeNode<T = unknown> implements ITreeNode<T> {
	...
	export declare class TreeCollection<T = unknown> implements ICollection<T, ITreeNode<T>> {
	...
	export declare const EmptyData: ArrayBuffer;
	export declare function IsObject(item: unknown): boolean;
	export declare function CatchThrowError(error: any): any;
	export declare function CatchCapture<T = unknown>(capture: Capture): (error: unknown) => T;
	...
	export declare function FlattenObject<T = unknown>(entries: Record<string, T>, accessor?: string): {
	    access: string;
	    value: T;
	}[];
	...
	export declare function $RacePromise<T = unknown>($promise: Promise<T>, race: number): Promise<T>;
	export declare function $RacePromise<T = unknown>($promise: Promise<T>, race: number, capture: Capture): Promise<T>;
	export declare function $UseRace<Resolve = unknown, Reject = unknown>(race: number, options?: {
	    capture?: Capture;
	}): $Promise<Resolve, Reject>;
	export declare function $Wait<S, T>(delay: number, options?: {
	    reject?: T;
	    resolve?: S;
	}): Promise<S | T>;
	...
	export declare const DebugCipher: Cipher;
	
		export declare function MD5(string: string): string;
	
		
	export declare function EncodeNumber(value: number): ArrayBuffer;
	export declare function EncodeNumber(value: number, data: ArrayBuffer): ArrayBuffer;
	export declare function DecodeNumber(data: ArrayBuffer): number;
	export declare function EncodedStringSize(value: string): number;
	export declare function EncodeString(value: string): ArrayBuffer;
	export declare function DecodeString(buffer: ArrayBuffer): string;
	export declare function DecodeAttributes(buffer: ArrayBuffer): Attributes;
	export declare function EncodeAttributes(attributes: Attributes): ArrayBuffer;
	...
	export declare class EnforcementResult {
	    value: unknown;
	    success: Attributes;
	    error: Attributes;
	    logs: string[];
	...
	export declare class EnforcementInquiry {
	...
	export declare function $Enforce<T = unknown[]>($values: EnforceableValue[], $inquiries: EnforcementInquiry): Promise<T>;
	export declare function $Enforce<T = unknown[]>($values: EnforceableValue[], $inquiries: EnforcementInquiry[]): Promise<T>;
	export declare function Enforce(values: IterableIterator<EnforceableValue>, inquiries: IterableIterator<EnforcementInquiry>): EnforcementResult;
	...
	export declare class AttributesQuery {
	...
	export declare class QueryManager<T = unknown> implements IQuery<T> {
	...
	export declare class WaitingQueryManager<T> implements IWaitingQuery<T> {
	...
	export declare class SequentialThottle<T = unknown> implements IThottle<T> {
	...
	export declare class CallbackAction extends AbstractForgeAction {
	 ...
	 *
	 */
	export declare class AbstractForgeAction extends Subscription implements IAction {
	    protected _data: any;
	...
	export declare class SocketAction extends AbstractForgeAction {
	...
	export declare class ForgeAccess {
		...
		export declare class ForgeAuthorization<S, T> {
		...
		export declare class ForgeUser {
	    private _groups;
	    private: any;
	}
	...
	export declare class BrowserExtension extends AcbstractExtension {
	...
	export declare class AcbstractExtension implements IForgeBuildExtension {
	    $start(entry: string, manifest: Record<string, unknown>, BuildOptions: Record<string, unknown>): Promise<void>;
	    $header(content: string): Promise<string>;
	    $section(content: string, sectionEntry: SectionEntry): Promise<string>;
	    $footer(content: string): Promise<string>;
	...
	export declare class NodeExtension extends AcbstractExtension {
	    $complete(content: string): Promise<string>;
	}
	
		export declare class ForgeRace {
	    private _default;
	    private _race;
	...
	export declare class ForgeController {
	...
	export declare class ForgeTask {
	    ...
	    static Path: {
	        ...
	        Resolve: (...rest: string[]) => string;
	        Relative: (source: string, target: string) => string;
	    ...
	    static Read(path: string): ArrayBuffer;
	    ...
	    static $Walk(root: any, fileList: string[]): Promise<string[]>;
	}
	...
	export declare function $CompareModels(iModelA: IForgeModel, iModelB: IForgeModel): Promise<boolean>;
	...
	export declare class ForgeModel implements IForgeModel {
	...
	export declare class FileModelPipe extends AbstractForgeModelProxy {
	...
	export declare class AbstractForgeModelProxy extends Subscription implements IForgeModelProxy {
	    protected _iModel: IForgeModel;
	...
	export declare class ForgeModelProxyManager {
	...
	export declare class ClientSocketModelProxy extends AbstractForgeModelProxy {
	    private _iSocket;
	    private _rootHash;
	    private _state;
	...
	export declare class RootSocketModelProxy extends AbstractForgeModelProxy {
	...
	export declare enum ForgeStoreMime {
	...
	export declare function $CompareStores(iStoreA: IForgeStore, iStoreB: IForgeStore): Promise<boolean>;
	...
	export declare class ForgeStore implements IForgeStore {
	    static Null: string;
	...
	export declare class JSONStore extends ForgeStore {
	...
	export declare class NumberStore extends ForgeStore {
	...
	export declare class StringStore extends ForgeStore {
	...
	export declare class ForgeRequest {
	    private _parseBody;
	    private _$body;
	...
	export declare class ForgeResponseChunk {
	    private _writes;
	    private _$complete;
	...
	export declare class ForgeResponse {
	    static publuic: any;
	    private _response;
	    private _writes;
	    private _status;
	...
	export declare function $ParseRequestBody(request: any): Promise<[ArrayBuffer, string]>;
	...
	export declare class FileRoute extends ForgeRoute {
	    private _file;
	    private _mime;
	    private _status;
	    private _cache;
	...
	export declare class FileDirectoryRoute extends ForgeRoute {
	    static Authorize: {
	...
	export declare class ForgeRoute implements IForgeRoute, IForgeRouteComponent {
	...
	export declare class CaptureRoute extends ForgeRoute {
	    private _$delegate;
	...
	export declare class HTTPRoute extends ForgeRoute {
	    private _root;
	...
	export declare class ExecSocket extends AbstractForgeSocket {
	    private _source;
	    private _command;
	    private _config;
	...
	export declare class AbstractForgeSocket extends Subscription implements IForgeSocket {
	    protected _name: string;
	    protected _key: string;
	    protected _reboot: boolean;
	    protected _stdio: StdioOption;
	...
	export declare class ForkSocket extends AbstractForgeSocket {
	    private _source;
	    private _commands;
	    private _args;
	...
	export declare class PluginService extends AbstractForgeSocket {
	    private _source;
	    private _commands;
	    constructor(name: string, config: SocketConfig, source?: any);
	    write(header: Serialize, data: Serialize): void;
	...
	export declare class PluginSocket extends AbstractForgeSocket {
	    private _source;
	    private _commands;
	    constructor(name: string, config: SocketConfig, source?: any);
	    write(header: Serialize, data: Serialize): void;
	...
	export declare class RestService extends AbstractForgeSocket {
	    private _source;
	    private _command;
	    private _config;
	    constructor(name: string, config: SocketConfig);
	...
	export declare class RestSocket extends AbstractForgeSocket {
	    private _source;
	    private _command;
	    private _config;
	    constructor(name: string, config: SocketConfig);
	...
	export declare class SpawnSocket extends AbstractForgeSocket {
	    private _source;
	    private _commands;
	    constructor(name: string, config: SocketConfig, source?: any);
	    private _onExit;
	...
	export declare class ForgeStorage implements IForgeStorage {
		...
		export declare const Something = "happy";
